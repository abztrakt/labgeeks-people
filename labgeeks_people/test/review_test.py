...
class ReviewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.dawgreview = UWLTReview.objects.create(id=1, user=self.dawg, date=d, reviewer=self.manager, dependability=3, productivity=4, customer_service=3, teamwork=4, integrity=5, technical_knowledge=3, attitude=5, responsibility=2, policies=4, communication=2, initiative=4, procedures=3)
        self.managerreview = UWLTReview.objects.create(id=2, user=self.manager, date=d, reviewer=self.bigboss, dependability=5, productivity=4, customer_service=5, teamwork=4, integrity=5, technical_knowledge=4, attitude=5, responsibility=4, policies=4, communication=4, initiative=4, procedures=3)
        self.bigbossreview = UWLTReview.objects.create(id=3, user=self.bigboss, date=d, reviewer=self.manager, dependability=5, productivity=4, customer_service=4, teamwork=4, integrity=5, technical_knowledge=5, attitude=5, responsibility=5, policies=4, communication=2, initiative=4, procedures=4)
