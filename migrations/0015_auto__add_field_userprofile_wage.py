...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('labgeeks_people_userprofile', 'wage', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labgeeks_people.WageHistory'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.wage'
        db.delete_column('labgeeks_people_userprofile', 'wage_id')
    ...
    models = {
        ...
        'labgeeks_people.userprofile': {
            ...
            'wage': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['labgeeks_people.WageHistory']", 'null': 'True', 'blank': 'True'}),
