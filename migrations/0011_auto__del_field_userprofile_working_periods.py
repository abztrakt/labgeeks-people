...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('labgeeks_people_userprofile_working_periods', (
            ...
            ('timeperiod', models.ForeignKey(orm['labgeeks_people.timeperiod'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.add_column('labgeeks_people_userprofile', 'working_periods', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labgeeks_people.TimePeriod'], null=True, blank=True), keep_default=False)
