...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('labgeeks_people_userprofile', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labgeeks_people.EmploymentStatus'], null=True))

        # Changing field 'UserProfile.supervisor'
        db.alter_column('labgeeks_people_userprofile', 'supervisor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'UserProfile.title'
        db.alter_column('labgeeks_people_userprofile', 'title_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labgeeks_people.Title'], null=True))

        # Changing field 'UserProfile.working_periods'
        db.alter_column('labgeeks_people_userprofile', 'working_periods_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labgeeks_people.TimePeriod'], null=True))
    ...
    models = {
        ...
        'labgeeks_people.userprofile': {
            ...
            'working_periods': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['labgeeks_people.TimePeriod']", 'null': 'True', 'blank': 'True'})
        },
