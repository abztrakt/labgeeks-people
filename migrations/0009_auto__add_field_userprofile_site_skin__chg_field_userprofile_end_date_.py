...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('labgeeks_people_userprofile', 'site_skin', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('labgeeks_people_userprofile', 'site_skin')

        # Changing field 'UserProfile.end_date'
        db.alter_column('labgeeks_people_userprofile', 'end_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'UserProfile.start_date'
        db.alter_column('labgeeks_people_userprofile', 'start_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'UserProfile.grad_date'
        db.alter_column('labgeeks_people_userprofile', 'grad_date', self.gf('django.db.models.fields.DateField')())
